...
**These modifications, updates and definition of variabels were built on previous available codebook and based on the following five project requirements**

(i) Merges the training and the test sets to create one data set.
(ii) Extracts only the measurements on the mean and standard deviation for each measurement.
(iii) Uses descriptive activity names to name the activities in the data set
(iv) Appropriately labels the data set with descriptive variable names.
(v) From the data set in step 4, creates a second, independent tidy data set with the average of each (vi) variable for each activity and each subject.

**The original data contained the following data sets **
(i) X_test, y_test and subject_test
(ii) X_train, y_train, and subject_train
(iii) activity_labels and features

The train and test dataset were combined and called merge_train and merge_test respectively.
They were both joined to make one large data and stored in an object called total_combined.

**features** dataset contains the correct names for the combined dataset, which were applied to the column names that were stored in the combined dataset()


**Below are the codes and explanation of how the data was generated and tranformed to get the final dataset that is clean**
